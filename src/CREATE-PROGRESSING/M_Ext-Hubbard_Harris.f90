...
! ===========================================================================
        subroutine initialize_eh_HARRIS
        implicit none
...
! ===========================================================================
        return
        end subroutine initialize_eh_HARRIS
! rho2c_store.f
! Program Description
! ====================================================================
!
...
! Open ouput file for this species pair
		           write (filename, '("/xc_eh.",i2.2,".",i2.2,".dat")')		&
